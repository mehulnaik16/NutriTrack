...
export const WORKOUT_LIBRARY: LibraryPlan[] = [
  {
    ...
    blurb:
      "The foundation. One major muscle group per day with surgical precision.",
    plan: {
  ...
  },
  {
    ...
    blurb:
      "The ULPPL split—trains each muscle twice a week for maximum growth.",
    plan: {
      ...
      library_id: 2,
      library_name:
        "PUSH/PULL/LEGS + UPPER/LOWER (Hybrid – 2–3 Muscles Per Day)",
    },
  },
  {
    id: 3,
    ...
    blurb:
      "Combines heavy strength work with high-volume hypertrophy for size and power.",
    plan: {
      ...
      library_id: 3,
      library_name:
        "THE POWERBUILDING SPLIT (Strength + Hypertrophy – 1–2 Muscles Per Day)",
    },
  },
  {
    id: 4,
  ...
  },
  {
    ...
    blurb:
      "Classic PPL structure with two push and two pull days, one leg day.",
    plan: {
      goal: "Push/Pull/Legs",
      days_per_week: 5,
      days: [
      ...
      library_id: 5,
      library_name:
        "THE PUSH/PULL/LEGS (PPL) – 5-DAY VARIATION (3 Muscles Per Day)",
    },
  },
  {
    id: 6,
    ...
    plan: {
      ...
      library_id: 6,
      library_name:
        "THE STRENGTH FOCUS (Low Reps, Heavy Weights – 1 Muscle Per Day)",
    },
  },
  {
    id: 7,
    ...
    blurb:
      "For pure hypertrophy. Higher sets and reps to stimulate maximum muscle growth.",
    plan: {
      goal: "Volume Monster",
      days_per_week: 5,
      days: [
      ...
      library_id: 7,
      library_name:
        "THE VOLUME MONSTER (High Volume, Moderate Weight – 2 Muscles Per Day)",
    },
  },
  {
    id: 8,
  ...
  },
  {
    ...
    blurb:
      "Hits the whole body with compound lifts every day, but with different emphasis.",
    plan: {
      ...
      library_id: 9,
      library_name:
        "THE 5-DAY FULL-BODY SPLIT (3 Muscles Per Day – Compound Focus)",
    },
  },
  {
    id: 10,
    ...
    blurb:
      "Incorporates dropsets, supersets, and forced reps for advanced lifters.",
    plan: {
  ...
  },
  {
    ...
    plan: {
      ...
      library_id: 11,
      library_name:
        "THE FUNCTIONAL STRENGTH SPLIT (2 Muscles Per Day – Athletic Focus)",
    },
  },
  {
    id: 12,
    ...
    plan: {
      ...
      library_id: 12,
      library_name:
        "THE MINIMALIST PLAN (1–2 Muscles Per Day – Only 5 Exercises Per Day)",
    },
  },
  {
    id: 13,
    ...
    blurb:
      "Based on principles used by champions—high volume, heavy weight, and intensity.",
    plan: {
      ...
      library_id: 13,
      library_name:
        "THE MR. OLYMPIA-INSPIRED SPLIT (1 Muscle Per Day – High Intensity)",
    },
  },
  {
    id: 14,
  ...
  },
  {
    ...
    blurb:
      "Higher reps, shorter rest, and supersets for a shredded, conditioned look.",
    plan: {
      ...
      library_id: 15,
      library_name:
        "THE FINAL CUT – DEFINITION & CONDITIONING (2–3 Muscles Per Day)",
    },
  },
];
