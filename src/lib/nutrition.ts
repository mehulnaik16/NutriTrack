...
const GOAL_MULTIPLIERS: Record<string, number> = {
  maintain: 1.0,
  "Maintain Weight": 1.0, // legacy
  lose_0_25kg: 0.9,
  lose_0_5kg: 0.8,
  lose_0_75kg: 0.7,
  "Lose Weight": 0.8, // legacy → default to −20%
  gain_muscle: 1.1,
  "Gain Muscle": 1.1, // legacy
  gain_0_25kg: 1.1,
  gain_0_5kg: 1.2,
  gain_0_75kg: 1.3,
};
...
export const LOSE_RATE_OPTIONS = [
  {
    value: "lose_0_25kg",
    label: "0.25 kg / week",
    detail: "Very conservative · −250 kcal/day",
  },
  {
    value: "lose_0_5kg",
    label: "0.5 kg / week",
    detail: "Steady & healthy · −500 kcal/day (NHS)",
  },
  {
    value: "lose_0_75kg",
    label: "0.75 kg / week",
    detail: "Aggressive · −750 kcal/day",
  },
] as const;
...
export const GAIN_RATE_OPTIONS = [
  {
    value: "gain_0_25kg",
    label: "0.25 kg / week",
    detail: "Lean bulk · +250 kcal/day",
  },
  {
    value: "gain_0_5kg",
    label: "0.5 kg / week",
    detail: "Standard bulk · +500 kcal/day",
  },
  {
    value: "gain_0_75kg",
    label: "0.75 kg / week",
    detail: "Aggressive bulk · +750 kcal/day",
  },
] as const;
...
export function decomposeGoalKey(key: string): {
  primary: string;
  loseRate?: string;
} {
  if (key === "lose_0_25kg")
    return { primary: "lose", loseRate: "lose_0_25kg" };
  if (key === "lose_0_5kg") return { primary: "lose", loseRate: "lose_0_5kg" };
  if (key === "lose_0_75kg")
    return { primary: "lose", loseRate: "lose_0_75kg" };
  if (key === "gain_0_25kg")
    return { primary: "gain", loseRate: "gain_0_25kg" };
  if (key === "gain_0_5kg") return { primary: "gain", loseRate: "gain_0_5kg" };
  if (key === "gain_0_75kg")
    return { primary: "gain", loseRate: "gain_0_75kg" };
  if (key === "gain_muscle")
    return { primary: "gain", loseRate: "gain_0_25kg" }; // legacy → default
...
export function calcCalorieTarget(
  ...
  const multiplier = GOAL_MULTIPLIERS[goalKey] ?? 1.0;
